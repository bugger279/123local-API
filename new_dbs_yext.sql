...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2019 at 03:30 PM
...
INSERT INTO `bio_items_certification` (`bioItemsCertificationId`, `bioItemsId`, `bioItemsCertificationName`) VALUES
(1, 1, 'Chiropractory United'),
(2, 1, 'Verified Provider');
...
INSERT INTO `bio_items_education` (`bioItemsEducationId`, `bioItemsId`, `bioItemsEducationName`) VALUES
(1, 1, 'Bachelor of Science, Cambridge University'),
(2, 1, 'USD Medical School');
...
INSERT INTO `bio_items_service` (`bioItemsServiceId`, `bioItemsId`, `bioItemsServiceName`) VALUES
(1, 1, 'Spinal Decompression'),
(2, 1, 'Genetics Disorders');
...
(1, 4, 'Gaelic Storm', 'Concert', '2012-08-23T20:00-05', '2012-08-24T20:00-05', '$20 tickets.  Doors at 8pm, show at 9pm.', 'http://www.youtube.com/watch?v=jtCEvGxZVIM', 'http://www.boweryballroom.com/event/125975'),
(8, 14, 'Gaelic Storm', 'Concert', '2012-08-23T20:00-05', '2012-08-24T00:00-05', '$20 tickets.  Doors at 8pm, show at 9pm.', 'http://www.youtube.com/watch?v=jtCEvGxZVIM', 'http://www.boweryballroom.com/event/125975'),
(9, 18, 'Gaelic Storm', 'Concert', '2012-08-23T20:00-05', '2012-08-24T00:00-05', '$20 tickets.  Doors at 8pm, show at 9pm.', 'http://www.youtube.com/watch?v=jtCEvGxZVIM', 'http://www.boweryballroom.com/event/125975');
...
INSERT INTO `events_items_photos` (`eventsItemsPhotosId`, `eventsItemsId`, `eventsItemsPhotoUrl`, `eventsItemsPhotoHeight`, `eventsItemsPhotoWidth`) VALUES
(1, 1, 'http://www.yext-static.com/cms/detail-sander.jpg', 250, 250),
(2, 1, 'http://www.yext-static.com/cms/detail-sander2.jpg', 250, 250),
(9, 8, 'http://www.yext-static.com/cms/detail-sander.jpg', 250, 250),
(10, 8, 'http://www.yext-static.com/cms/detail-sander2.jpg', 250, 250),
(11, 9, 'http://www.yext-static.com/cms/detail-sander.jpg', 250, 250),
(12, 9, 'http://www.yext-static.com/cms/detail-sander2.jpg', 250, 250);
...
(1, 2, 'Chocolate Croissant', 'A tantalizing treat', 'http://www.yext-static.com/cms/chocolate-croissant.jpg', 250, 250, 'RANGE', 300, 350),
(5, 4, 'Chocolate Croissant', 'A tantalizing treat', 'http://www.yext-static.com/cms/chocolate-croissant.jpg', 250, 250, 'RANGE', 300, 350),
(6, 6, 'Chocolate Croissant', 'A tantalizing treat', 'http://www.yext-static.com/cms/chocolate-croissant.jpg', 250, 250, 'RANGE', 300, 350);
...
(5, 5, 'RANGE', '9.50', 'Per Sandwich', '', ''),
(6, 6, 'RANGE', '9.50', 'Per Sandwich', '', '');
...
(1, 5, 'Black & Decker MOUSE Detail Sander with Dust Collection', 'Black & Decker MOUSE Detail Sander with Dust Collection descriptions.........', 'http://www.youtube.com/watch?v=cGW0XKYeM6o', 'http://www.kmart.com/deal-of-the-day/dap-120000000279845'),
(2, 17, 'Black &amp; Decker MOUSE Detail Sander with Dust Collection', 'Description of the product or service (long form)', 'http://www.youtube.com/watch?v=cGW0XKYeM6o', 'http://www.kmart.com/deal-of-the-day/dap-120000000279845');
...
INSERT INTO `service_items_cost` (`serviceItemsCostId`, `serviceItemsId`, `serviceItemsCostType`, `serviceItemsCostPrice`, `serviceItemsCostUnit`, `serviceItemsCostRangeTo`, `serviceItemsCostOther`) VALUES
(1, 1, 'PRICE', '19.50', 'Per Piece', '', ''),
(2, 2, 'PRICE', '9.50', 'One Antique', '', '');
...
INSERT INTO `service_items_cost_options` (`serviceItemsCostOptionsId`, `serviceItemsCostId`, `costOptionName`, `costOptionPrice`, `costOptionCalorie`) VALUES
(1, 1, 'Large', '10.00', 0),
(2, 1, 'Small', '15.60', 0),
(3, 2, 'Bacon', '1.00', 150);
...
INSERT INTO `service_items_photos` (`serviceItemsPhotosId`, `serviceItemsId`, `serviceItemsPhotoUrl`, `serviceItemsPhotoHeight`, `serviceItemsPhotoWidth`) VALUES
(1, 1, 'http://www.yext-static.com/cms/detail-sander.jpg', 250, 250),
(2, 1, 'http://www.yext-static.com/cms/detail-sander2.jpg', 250, 250),
(3, 2, 'http://www.yext-static.com/cms/detail-sander.jpg', 250, 250),
(4, 2, 'http://www.yext-static.com/cms/detail-sander2.jpg', 250, 250);
...
--
ALTER TABLE `events_items`
  MODIFY `eventsItemsId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `events_items_photos`
--
ALTER TABLE `events_items_photos`
  MODIFY `eventsItemsPhotosId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `menu_items`
  MODIFY `menuItemsId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `menu_items_cost`
--
ALTER TABLE `menu_items_cost`
  MODIFY `menuItemsCostId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `menu_items_cost_options`
--
ALTER TABLE `menu_items_cost_options`
  MODIFY `menuItemsCostOptionsId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `service_items`
  MODIFY `serviceItemsId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `service_items_cost`
--
ALTER TABLE `service_items_cost`
  MODIFY `serviceItemsCostId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `service_items_cost_options`
--
ALTER TABLE `service_items_cost_options`
  MODIFY `serviceItemsCostOptionsId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `service_items_photos`
--
ALTER TABLE `service_items_photos`
  MODIFY `serviceItemsPhotosId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
